...
# Clone kernel tree
git clone https://github.com/Little-Chenfeng-ID/device_xiaomi_chenfeng-kernel.git -b lineage-23.2 device/xiaomi/chenfeng-kernel

# Clone hardware xiaomi
git clone https://github.com/Little-Chenfeng-ID/hardware_xiaomi.git -b lineage-23.2 hardware/xiaomi
